...
const { getFollowing } = require("../models/follow");
...
// Implement getFeed controller for content feed functionality
...
const update = async (req, res) => {
  try {
    ...
    const success = await updatePost(parseInt(post_id), userId, { content, media_url });
...
const searchPosts = async (req, res) => {
  try {
    ...
    const posts = await searchPostsByContent(search, limit, offset);
